        ...
        <div className="bg-grayBg animated_object w-80 h-96 md:w-96 md:h-projectHeight gap-2 rounded-3xl flex flex-col items-center justify-center text-white border-4 border-darkGrayBg hover:scale-110 transition-all">
          ...
          <div className="flex gap-3">
            <a target='_blank' rel="nonopenner referer noreferrer" href="https://github.com/VictorAlencar00/trainee">
              {' '}
              <button className='bg-aboutBg text-softWhite h-11 p-3 flex items-center border-darkGrayBg border-solid border-x border-y rounded-3xl cursor-pointer m-1 transition-all hover:border-black hover:bg-softWhite hover:scale hover:text-black hover:scale-110'>Repositório</button>
            </a>
          </div>
        </div>
        <div className="bg-grayBg animated_object w-80 h-96 md:w-96 md:h-projectHeight gap-2 rounded-3xl flex flex-col items-center justify-center text-white border-4 border-darkGrayBg hover:scale-110 transition-all">
